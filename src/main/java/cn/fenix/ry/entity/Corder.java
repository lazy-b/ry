...
public class Corder {
	...
	public String toString() {
		return "Corder [id=" + id + ", orderDate=" + orderDate + ", requiredDate=" + requiredDate + ", orderNo="
				+ orderNo + ", materialCoding=" + materialCoding + ", productName=" + productName + ", orderAmount="
				+ orderAmount + ", spareParts=" + spareParts + ", stockAmount=" + stockAmount + ", planAmount="
				+ planAmount + ", materialModel=" + materialModel + ", purchaseRequirement=" + purchaseRequirement
				+ ", replyDate=" + replyDate + ", orderStatus=" + orderStatus + ", exceptionReason=" + exceptionReason
				+ ", price=" + price + ", remark=" + remark + ", orderType=" + orderType + "]";
	}
